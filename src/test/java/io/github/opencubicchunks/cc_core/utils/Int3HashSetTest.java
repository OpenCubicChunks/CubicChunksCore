...
public class Int3HashSetTest {
    ...
    protected void test(int nPoints, ToIntFunction<ThreadLocalRandom> rng) {
        Set<MCVec3i> reference = new HashSet<>(nPoints);
        ...
        try (Int3HashSet test = new Int3HashSet()) {
            ...
            for (Iterator<MCVec3i> itr = reference.iterator(); itr.hasNext(); ) { //remove some positions at random
                MCVec3i pos = itr.next();
    ...
    protected void ensureEqual(Set<MCVec3i> reference, Int3HashSet test) {
    ...
    protected void testDuplicateInsertion(ToIntFunction<ThreadLocalRandom> rng) {
        Set<MCVec3i> reference = new HashSet<>();
        ThreadLocalRandom r = ThreadLocalRandom.current();
